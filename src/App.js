...
function Product(props) {
  const imgsrc = "https://via.placeholder.com/350x300";
...
function App() {
  const [items] = useState([
    { name: "Fancy Product", price: "40$ - 80$", addedToCart: false },
    { name: "Special Item", price: "18$", addedToCart: false },
    { name: "Sale Item", price: "25$", addedToCart: false },
    { name: "Popular Product", price: "40$", addedToCart: false },
  ...
  return (
    <div className="App">
      ...
      <div className="container">
        ...
        <p className="sub-heading">With this shop hompeage template</p>
      </div>
